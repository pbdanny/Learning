...
class Binomial(Distribution):
    ...
    def pdf(self, k):
        ...
        """
        binom_coef = math.factorial(self.n)/(math.factorial(k) * math.factorial(self.n - k))
        binom_prop = math.pow(self.p, k) * math.pow((1-self.p), self.n - k)

        return binom_coef * binom_prop
    ...
    def __add__(self, other):    
        ...
        add_binom = Binomial(self.n, self.p)
        add_binom.p = self.p
        add_binom.n = self.n + other.n
    ...
    def __repr__(self):
        ...
        print('mean {}, standard deviation {:.1f}, p {:.1f}, n {}'.format(self.mean, self.stdev, self.p, self.n))
        pass
